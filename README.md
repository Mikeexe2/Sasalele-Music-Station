<img src="public/assets/sasalele_logo.webp" width="45" style="vertical-align: middle;"> Sasalele Music Station

A versatile, lightweight web-based media hub for Radio, Video, and Cloud-stored music. Optimized for high-performance streaming with a focus on Japanese and global music culture.

[🌐 Launch Live App](https://basic.pp.ua)
...
- Dynamic Filtering: Instantly filter the station list by Name or Tags.
- M3U Export: Generate playlists for external players like VLC or Poweramp.
- Random Play: Use "Random Play" feature pick a high-quality station for you.
- Multi-Platform Search: One click redirects you to find the current track on Last.fm, iTunes, Deezer, YouTube, or Google.
- RadioBrowser API: Able to search the community-driven database to discover hidden gems from around the world.
- Custom Streams: Support for pasting custom URLs and .m3u8 stream links for direct browser playback.
- Curated Playlists: Special access to curated music playlists featuring real-time lyrics display.
- Real-time Chat: Easily copy stream titles and jump into the integrated chat to discuss what's playing.
- Always Live: We regularly prune dead links. If a station is down, suggest a replacement via the site chat or Telegram.

## 📺 Global Video Hub

Global live streaming international content.
...
## ☁️ Google Drive Personal Streamer
...
- 0x40 Hues Mode (Simulation): Rhythmic visualizer mode with synchronized background transitions.

- Dynamic UI: Randomized high-quality wallpapers on every refresh.

- PWA Ready: Install as a standalone app on iOS, Android, or Desktop for an "app-like" experience without address bars.
